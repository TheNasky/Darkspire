            ...
            >
              {slot.character && (
                <button
                  ...
                  className="absolute top-2 right-2 w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-red-500/10 
                           hover:bg-red-500 text-red-500 hover:text-white flex items-center justify-center
